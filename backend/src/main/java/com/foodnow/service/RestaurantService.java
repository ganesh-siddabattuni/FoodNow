...
public class RestaurantService {
    ...
    public void readyForPickup(int orderId) {
        ...
        List<User> availableAgents = userRepository.findByRoleAndDeliveryStatus(Role.DELIVERY_PERSONNEL,
                DeliveryAgentStatus.ONLINE);
    ...
    public void deleteFoodItem(int itemId) {
        ...
        // We will no longer modify the parent Restaurant's menu list in this
        // transaction
        // to avoid the end-of-transaction conflict. The frontend will refresh the data
        // anyway.
